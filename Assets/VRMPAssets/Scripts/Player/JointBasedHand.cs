...
namespace XRMultiplayer
{
    ...
    public class JointBasedHand : MonoBehaviour
    {
        ...
        private void Start()
        {
            //m_CurrentPlatformIndex = GetComponentInParent<XRINetworkPlayer>().platformType.Value;//old verison
            m_CurrentPlatformIndex = 0;//manually set to quest by aubrey august 2026
            //CheckForUpdate();//also commented out by aubrey in august 2026
        }
