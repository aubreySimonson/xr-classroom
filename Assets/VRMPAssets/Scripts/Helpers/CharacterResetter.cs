...
namespace XRMultiplayer
{
    public class CharacterResetter : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ResetPlayer();//this is not the line that moves the avatars eyes to a stupid position when you hit the start button -- aubrey 7/7/2026
        }
        ...
        {
            ResetPlayer(m_ResetPosition);//this is not the line that moves the avatars eyes to a stupid position when you hit the start button -- aubrey 7/7/2026
        }
